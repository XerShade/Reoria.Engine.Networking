...
public class SecureServerSocketServices(ILogger<ISocketBase> logger, ISecureSocketConfiguration configuration, ISecureSocketBuffer buffer, ISessionManager<ISecureSession> sessionManager) 
